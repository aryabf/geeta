...
{
    private float attackInterval = 1.1366f;
    ...
    public static PlayerMovementTest player { get; private set; }
    ...
    void Start()
    {
        ...
        playingSounds = new AudioSource[] {sound1, sound2, sound3, sound4, sound5};
    ...
    private IEnumerator FasterYetFaster() {
        yield return new WaitForSeconds(154.2f);
